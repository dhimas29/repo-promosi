                                                        ...
                                                        <?php if ($sub['subsubkriteria_id'] != "") : ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="config/subsubkriteria/proses_hapus.php?&id=<?php echo $sub['subsubkriteria_id'] ?>" class="btn btn-xs btn-danger" title="Hapus" onclick="return confirm('Apakah anda yakin ingin menghapus <?php echo $sub['nama_subsubkriteria'] ?>?')">
