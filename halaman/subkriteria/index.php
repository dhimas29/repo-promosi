                                            ...
                                            <?php foreach ($datas as $data) : ?>
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        ...
                                                        <a href="config/subkriteria/proses_hapus.php?&id=<?php echo $data[0]['id'] ?>" class="btn btn-xs btn-danger" title="Hapus" onclick="return confirm('Apakah anda yakin ingin menghapus <?php echo $data_sub['nama_subsubkriteria'] ?>?')">
