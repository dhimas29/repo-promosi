        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Seleksi Promosi Pegawai</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                            ...
                                            <?php foreach ($hasil as $key => $value) : ?>
                                                <tr>
                                                    ...
                                                    if ($row > 0) {
                                                        ...
                                                        $sql = mysqli_query($koneksi, "INSERT INTO hasil_seleksi (calon_id,status,persetujuan)values('$value[id]','$value[status]','$persetujuan')");
                                                    }
                                                    ?>
                                                    <td><?php echo $key ?></td>
                                                    ...
                                                    <td>
                                                        <span class="label label-<?php echo $value['status'] == 'Dapat di Promosikan' ? 'warning' : 'default' ?>">
